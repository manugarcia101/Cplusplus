...
Sucesor::Sucesor() :NumOcurrencias(0), Termino("")
{

}


Sucesor::Sucesor(int ocurrencias, std::string termino) :NumOcurrencias(ocurrencias), Termino(termino)
{

}

Sucesor::Sucesor(const Sucesor &orig) : NumOcurrencias(orig.NumOcurrencias), Termino(orig.Termino)
{
